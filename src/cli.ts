...
console.log(`
 ...
 | (_| |  __/\\__ \\   <| |_| | | | | | | | (_| |
  ...
  .command('package-client', 'Package and zip up your client. Also generates needed manifest files', (yargs) => {
    return yargs
  }, async () => {
  ...
  .command('init', 'Setup the DeskThing template', (yargs) => {
    return yargs
  }, async () => {
  ...
  .command('init-config', 'Create a typed configuration file', (yargs) => {
    return yargs
  }, async () => {
